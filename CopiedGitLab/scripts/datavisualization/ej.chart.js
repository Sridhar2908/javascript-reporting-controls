/* global jQuery, ej, document, navigator, window, clearTimeout, setTimeout, event */
ej.ejChart = {};
(function ($) {
    if (!Object.keys) {
    ...
    ej.ejChart = {
                ...
                for (i = 0; i < visibleSeriesLength; i++) {
                    ...
                    if (currentSeries._enableSmartLabels && this.model.AreaType == "cartesianaxes") {
                        ...
                        for (j = 0; j < points.length; j++) {
                            ...
                            currentPoint.hide = ej.util.isNullOrUndefined(currentPoint.hide) ? false : currentPoint.hide;
        ...
        checkOutsideLabels: function (model, currentPoint, areaBounds) {
            ...
            if (model.series[currentPoint.seriesIndex].marker.dataLabel.showEdgeLabels) {
                currentPointXPos = isCanvas ? currentPoint.xPos - this.canvasX : currentPoint.dataLabel.textX;
                currentPointYPos = isCanvas ? currentPoint.yPos - this.canvasY : currentPoint.dataLabel.textY;
                ...
                if ((currentPointXPos - currentPoint.dataLabel.width / 2 < 0) || (currentPointXPos + currentPoint.dataLabel.width / 2 > width) ||
                    (currentPointYPos + currentPoint.dataLabel.height / 2 > height) || (currentPointYPos - currentPoint.dataLabel.height / 2 < 0))
                    return true;
            }
        },
        ...
        chartMouseUp: function (evt) {
            ...
            if (chart.dragPoint) {
                $("#" + this._id).find('[id*="_Marker"]').remove();
            ...
            if ((ej.isTouchDevice() || model.zooming.enableDeferredZoom) && this.panning && this.doPan && model.AreaType == "cartesianaxes") {
                ...
                this.model.legendCollapsed = false;
                panEndEventArgs = panStartEventArgs = $.extend({}, ej.EjSvgRender.commonChartEventArgs),
                    $proxy = this;
        ...
        _axisMeasure: function (axis, realWidth, orientation, j) {
            ...
            axis.majorTickLines.size = axis.visible ? (axis.majorTickLines.size < 0 ? 0 : axis.majorTickLines.size) : 0;
            ...
            if ((j == 0) && (axis.tickLinesPosition == 'inside' && axis.labelPosition == 'inside'))
                ...
                axis.AxisMaxWidth = axisTitleHeight + multiLevelLabelSize + axisLineWidth + (elementSpacing) + axis.majorTickLines.size;
            else
                axis.AxisMaxWidth = axisTitleHeight + multiLevelLabelSize + axisLineWidth + elementSpacing + axis.majorTickLines.size + labelSize;
